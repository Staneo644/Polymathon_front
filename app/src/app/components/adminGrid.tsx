  ...
  return (
    <div className="container mx-auto  overflow-scroll table-fixed w-90vw">
      <table className="min-w-full divide-y divide-x divide-gray-200  overflow-scroll table-fixed">
        <thead>
          <tr>
            <th className="px-2 py-2 w-1/10 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
              Mot
            </th>
        ...
        <tbody className="bg-white divide-y divide-x divide-gray-200">
          {wordList.map((word, index) => (
            <tr key={index}>
              ...
              <td className="px-2 py-2 border-r">
                <div className="overflow-scroll">{word.gender}</div>
              </td>
              <td className="px-2 py-2 border-r">
                <div className="max-h-[100px] overflow-scroll w-72">
                  {word.definition}
                </div>
              </td>
              <td className="px-2 py-2 overflow-x-auto border-r">
                <div className="w-72">{word.etymology}</div>
              </td>
